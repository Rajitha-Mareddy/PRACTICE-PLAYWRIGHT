...
- Name: E2E.spec.ts >> E2E Tests >> invalidPassword login
- Location: tests\E2E.spec.ts:61:11
...
Call log:
  - waiting for locator('#login')
    - locator resolved to <input id="login" name="login" type="submit" value="Login" _ngcontent-siu-c31="" class="btn btn-block login-btn"/>
