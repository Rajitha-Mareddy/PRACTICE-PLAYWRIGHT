...
- Name: E2E.spec.ts >> E2E Tests >> invalidBoth login
- Location: tests\E2E.spec.ts:68:12
...
Call log:
  - waiting for locator('#login')
    - locator resolved to <input id="login" name="login" type="submit" value="Login" _ngcontent-jtg-c31="" class="btn btn-block login-btn"/>
