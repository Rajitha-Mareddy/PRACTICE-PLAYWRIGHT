...
- Name: E2E.spec.ts >> E2E Tests >> Valid login
- Location: tests\E2E.spec.ts:46:9
...
Call log:
  - waiting for locator('#login')
    - locator resolved to <input id="login" name="login" type="submit" value="Login" _ngcontent-cwb-c31="" class="btn btn-block login-btn"/>
