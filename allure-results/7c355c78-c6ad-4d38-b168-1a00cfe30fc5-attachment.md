...
Call log:
  - waiting for locator('.product-image-wrapper').nth(11).locator('a').filter({ hasText: 'Add to cart' }).last()
    - locator resolved to <a data-product-id="14" class="btn btn-default add-to-cart">…</a>
