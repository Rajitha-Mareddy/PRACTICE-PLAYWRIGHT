...
Call log:
  - waiting for locator('.product-image-wrapper').nth(9).locator('a').filter({ hasText: 'Add to cart' }).last()
    - locator resolved to <a data-product-id="12" class="btn btn-default add-to-cart">…</a>
