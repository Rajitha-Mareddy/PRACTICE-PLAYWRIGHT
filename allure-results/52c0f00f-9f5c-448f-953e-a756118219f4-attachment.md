...
- Name: E2E.spec.ts >> E2E Tests >> invalidUsername login
- Location: tests\E2E.spec.ts:54:10
...
Call log:
  - waiting for locator('#login')
    - locator resolved to <input id="login" name="login" type="submit" value="Login" _ngcontent-yqh-c31="" class="btn btn-block login-btn"/>
